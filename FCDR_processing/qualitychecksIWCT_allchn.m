...
count_medianIWCT_orig(1,:)=median(iwctch1,2,'omitnan');
count_medianIWCT_orig(2,:)=median(iwctch2,2,'omitnan');
count_medianIWCT_orig(3,:)=median(iwctch3,2,'omitnan');
count_medianIWCT_orig(4,:)=median(iwctch4,2,'omitnan');
count_medianIWCT_orig(5,:)=median(iwctch5,2,'omitnan');                            
...
count_medianthrIWCT_orig(2)=3*iwctcountallandev_med(2,1);% 9.64
count_medianthrIWCT_orig(3)=3*iwctcountallandev_med(3,1);% 18.06
count_medianthrIWCT_orig(4)=3*iwctcountallandev_med(4,1);% 11.47
count_medianthrIWCT_orig(5)=3*iwctcountallandev_med(5,1);% 8.35
...
limitIWCT_orig(2)=5*iwctcountallandev_med(2,1);
limitIWCT_orig(3)=5*iwctcountallandev_med(3,1);
limitIWCT_orig(4)=5*iwctcountallandev_med(4,1);
limitIWCT_orig(5)=5*iwctcountallandev_med(5,1);
