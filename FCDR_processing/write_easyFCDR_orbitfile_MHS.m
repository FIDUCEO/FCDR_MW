...
%filenamenew=['/scratch/uni/u237/users/ihans/FIDUCEO_testdata/',selectsatellite,'/','FIDUCEO_FCDR_L1C_',upper(sen),'_',upper(sat),'_',ymdhms_start,'_',ymdhms_end,'_EASY_v3.0_fv1.1.4','.nc'];
%filenamenew=['/scratch/uni/u237/users/ihans/xchange/',selectsatellite,'/',num2str( vectorstartdate(1), '%02i'),'/',num2str( vectorstartdate(2), '%02i'),'/',num2str( vectorstartdate(3), '%02i'),'/','FIDUCEO_FCDR_L1C_',upper(sen),'_',upper(sat),'_',ymdhms_start,'_',ymdhms_end,'_EASY_v2.2_fv1.1.5','.nc'];
filenamenew=['/scratch/uni/u237/users/ihans/xchange/metopb_v2_2/','FIDUCEO_FCDR_L1C_',upper(sen),'_',upper(sat),'_',ymdhms_start,'_',ymdhms_end,'_EASY_v2.2_fv1.1.5','.nc'];
...
%filenamenew=['/scratch/uni/u237/user_data/ihans/FCDR/easy/harmonisation_test_FCDRv2_0/',selectsatellite,'/',num2str( vectorstartdate(1), '%02i'),'/',num2str( vectorstartdate(2), '%02i'),'/',num2str( vectorstartdate(3), '%02i'),'/','FIDUCEO_FCDR_L1C_',upper(sen),'_',upper(sat),'_',ymdhms_start,'_',ymdhms_end,'_EASY_v2.0_fv1.1.4_Ha1old_HdTw','.nc'];%_alphan18_Ha1_HdTw
...
%   nccreate(filenamenew,'/channel','Dimensions',{'abbrev_len',3,'channel',5},... 
%           'Datatype','char','Format','netcdf4','DeflateLevel',defl_level)
%   channel_var=char('Ch1','Ch2','Ch3','Ch4','Ch5').';%['Ch1';'Ch2';'Ch3';'Ch4';'Ch5']; 
%   ncwrite(filenamenew,'/channel',channel_var)
...
%   
 ...
 %         'Datatype','int16','Format','netcdf4','FillValue',fillvalint16,'DeflateLevel',defl_level)    
  ...
  nccreate(filenamenew,'/u_common_Ch1_BT','Dimensions',{'x',90,'y',scanlinedimension},...
          'Datatype','uint32','Format','netcdf4','FillValue',fillvaluint32,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])
  nccreate(filenamenew,'/u_common_Ch2_BT','Dimensions',{'x',90,'y',scanlinedimension},...
          'Datatype','uint32','Format','netcdf4','FillValue',fillvaluint32,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])
  nccreate(filenamenew,'/u_common_Ch3_BT','Dimensions',{'x',90,'y',scanlinedimension},...
          'Datatype','uint32','Format','netcdf4','FillValue',fillvaluint32,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])   
  nccreate(filenamenew,'/u_common_Ch4_BT','Dimensions',{'x',90,'y',scanlinedimension},...
          'Datatype','uint32','Format','netcdf4','FillValue',fillvaluint32,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])
  nccreate(filenamenew,'/u_common_Ch5_BT','Dimensions',{'x',90,'y',scanlinedimension},...
          'Datatype','uint32','Format','netcdf4','FillValue',fillvaluint32,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])    
  %nccreate(filenamenew,'/u_structuredrandom_btemps',size(btempsK))
  
%   nccreate(filenamenew,'/u_RFI_Ch1_BT','Dimensions',{'x',90,'y',scanlinedimension},...
%           'Datatype','int16','Format','netcdf4','FillValue',fillvalint16,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])
%   nccreate(filenamenew,'/u_RFI_Ch2_BT','Dimensions',{'x',90,'y',scanlinedimension},...
%           'Datatype','int16','Format','netcdf4','FillValue',fillvalint16,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])
%   nccreate(filenamenew,'/u_RFI_Ch3_BT','Dimensions',{'x',90,'y',scanlinedimension},...
%           'Datatype','int16','Format','netcdf4','FillValue',fillvalint16,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])   
%   nccreate(filenamenew,'/u_RFI_Ch4_BT','Dimensions',{'x',90,'y',scanlinedimension},...
%           'Datatype','int16','Format','netcdf4','FillValue',fillvalint16,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])
%   nccreate(filenamenew,'/u_RFI_Ch5_BT','Dimensions',{'x',90,'y',scanlinedimension},...
%           'Datatype','int16','Format','netcdf4','FillValue',fillvalint16,'DeflateLevel',defl_level,'ChunkSize',[chunkpix chunkline])    
%   
...
%   ncwrite(filenamenew,'/u_RFI_Ch1_BT',change_type_zero_nan('int16',squeeze(u_RFI_btemps_active(1,:,:))*invscfac_unr_RFI))
%   ncwrite(filenamenew,'/u_RFI_Ch2_BT',change_type_zero_nan('int16',squeeze(u_RFI_btemps_active(2,:,:))*invscfac_unr_RFI))
%   ncwrite(filenamenew,'/u_RFI_Ch3_BT',change_type_zero_nan('int16',squeeze(u_RFI_btemps_active(3,:,:))*invscfac_unr_RFI))
%   ncwrite(filenamenew,'/u_RFI_Ch4_BT',change_type_zero_nan('int16',squeeze(u_RFI_btemps_active(4,:,:))*invscfac_unr_RFI))
%   ncwrite(filenamenew,'/u_RFI_Ch5_BT',change_type_zero_nan('int16',squeeze(u_RFI_btemps_active(5,:,:))*invscfac_unr_RFI))
%   
...
for kfile=1:length(hdrinfo.dataset_name)
 ...
 ncwriteatt(filenamenew,'/','writer_version',['MATLAB script write_easyFCDR_orbitfile_MHS.m']);
...
%ncwriteatt(filenamenew,'/','satellite_instrument_date',[satsenyear,'/',ymdhms_start(5:6),'/',ymdhms_start(7:8),'/']);
 ncwriteatt(filenamenew,'/','comment',['WARNING: This is an early pre-beta version with harmonised Channel 3. ']);
...
% scanline specific
 ...
 ncwriteatt(filenamenew,'/Ch1_BT','long_name',['channel1-89.0GHz_toa_brightness_temperature']);
 ...
 ncwriteatt(filenamenew,'/Ch2_BT','long_name',['channel2-157.0GHz_toa_brightness_temperature']);
 ...
 ncwriteatt(filenamenew,'/Ch3_BT','long_name',['channel3-183.31pm1GHz_toa_brightness_temperature']);
 ...
 ncwriteatt(filenamenew,'/Ch4_BT','long_name',['channel4-183.31pm3GHz_toa_brightness_temperature']);
 ...
 ncwriteatt(filenamenew,'/Ch5_BT','long_name',['channel5-190.31GHz_toa_brightness_temperature']);
...
%  ncwriteatt(filenamenew,'/u_RFI_Ch1_BT','long_name',['uncertainty_of_channel1_toa_brightness_temperature_due_to_RFI']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch1_BT','units',['K']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch1_BT','scale_factor',scfac_unr_RFI); 
%  ncwriteatt(filenamenew,'/u_RFI_Ch1_BT','description',['Uncertainty of the TOA brightness temperature due to Radio Frequency Interference (RFI).']);
%  
%  
%  ncwriteatt(filenamenew,'/u_RFI_Ch2_BT','long_name',['uncertainty_of_channel2_toa_brightness_temperature_due_to_RFI']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch2_BT','units',['K']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch2_BT','scale_factor',scfac_unr_RFI); 
%  ncwriteatt(filenamenew,'/u_RFI_Ch2_BT','description',['Uncertainty of the TOA brightness temperature due to Radio Frequency Interference (RFI).']);
%  
% 
%  ncwriteatt(filenamenew,'/u_RFI_Ch3_BT','long_name',['uncertainty_of_channel3_toa_brightness_temperature_due_to_RFI']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch3_BT','units',['K']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch3_BT','scale_factor',scfac_unr_RFI); 
%  ncwriteatt(filenamenew,'/u_RFI_Ch3_BT','description',['Uncertainty of the TOA brightness temperature due to Radio Frequency Interference (RFI).']);
%  
% 
%  ncwriteatt(filenamenew,'/u_RFI_Ch4_BT','long_name',['uncertainty_of_channel4_toa_brightness_temperature_due_to_RFI']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch4_BT','units',['K']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch4_BT','scale_factor',scfac_unr_RFI); 
%  ncwriteatt(filenamenew,'/u_RFI_Ch4_BT','description',['Uncertainty of the TOA brightness temperature due to Radio Frequency Interference (RFI).']);
%  
%  
%  ncwriteatt(filenamenew,'/u_RFI_Ch5_BT','long_name',['uncertainty_of_channel5_toa_brightness_temperature_due_to_RFI']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch5_BT','units',['K']);
%  ncwriteatt(filenamenew,'/u_RFI_Ch5_BT','scale_factor',scfac_unr_RFI); 
%  ncwriteatt(filenamenew,'/u_RFI_Ch5_BT','description',['Uncertainty of the TOA brightness temperature due to Radio Frequency Interference (RFI).']);
%  
