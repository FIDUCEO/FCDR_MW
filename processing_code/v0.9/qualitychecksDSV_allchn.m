...
count_medianDSV_orig(1,:)=median(dsvch1,2);
count_medianDSV_orig(2,:)=median(dsvch2,2);
count_medianDSV_orig(3,:)=median(dsvch3,2);
count_medianDSV_orig(4,:)=median(dsvch4,2);
count_medianDSV_orig(5,:)=median(dsvch5,2);                            
...
count_medianthrDSV_orig(2)=3*dsvcountallandev_med(1,2);% 9.64 %  42.4404 MHSN18
count_medianthrDSV_orig(3)=3*dsvcountallandev_med(1,3);% 18.06 %59.0145 MHSN18
count_medianthrDSV_orig(4)=3*dsvcountallandev_med(1,4);% 11.47 % 42.4421 MHSN18
count_medianthrDSV_orig(5)=3*dsvcountallandev_med(1,5);% 8.35 %55.5902 MHSN18
...
limitDSV_orig(2)=5*dsvcountallandev_med(1,2);
limitDSV_orig(3)=5*dsvcountallandev_med(1,3);
limitDSV_orig(4)=5*dsvcountallandev_med(1,4);
limitDSV_orig(5)=5*dsvcountallandev_med(1,5);
...
% this dsv_mean_appliedflags_withoutMooncheck needs to be comined with the
